...
class TradeData(object):
    ...
    def __init__(self, df_s):
        ...
        Tests to add:
        - df_s in expected format
        - sanity check: low <= high; low <= open; low <= close; high >= open; high >= close; volume >= 0
        - implicit asusmption that one column's row value is NaN iff all in row are NaN
        """
        self.df_s = df_s
    ...
    def fill_forward(self):
        ...
        Tests to add:
        - only leading NaNs after transformations
        """
